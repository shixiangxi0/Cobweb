...
<p align="center">
  <span style="font-size: 2em; font-family: -apple-system, 'PingFang SC', 'Microsoft YaHei', 'Noto Sans SC', sans-serif; font-weight: 400; letter-spacing: 0.08em;">
    AI时代，一种离经叛道的游戏引擎范式
  </span>
</p>
...
| 世界 | 主权 | 职责 |
|------|------|------|
| 🧠 **逻辑世界** | 因果主权 | 所有影响未来推演的状态，只能由事件驱动修改 |
| 🎨 **表现世界** | 感知主权 | 如何呈现、动画时序、过渡效果，由渲染组件自治决定 |
...
- **局部因果** —— 可以理解为 Scene，局部自治，对应一颗渲染组件树。
